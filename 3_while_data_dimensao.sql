...
--21 Dez 2017 - verao
 ...
 if @data between cast(convert(char(4),@ano)+'-09-23' as date) 
	and cast(convert(char(4),@ano)+'-12-20' as date)
 set @estacaoAno = 'primavera'
 else if @data between cast(convert(char(4),@ano)+'-03-21' as date) 
 and cast(convert(char(4),@ano)+'-06-20' as date)
 set @estacaoAno = 'outono'
 else if @data between cast(convert(char(4),@ano)+'-06-21' as date) 
 and cast(convert(char(4),@ano)+'-09-22' as date)
